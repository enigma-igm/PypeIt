...
|         ``[[cube]]``: :ref:`cubepar`
|         ``[[cube_extraction]]``: :ref:`cubeextractionpar`
...
``cube_extraction``  :class:`~pypeit.par.pypeitpar.CubeExtractionPar`  ..       `CubeExtractionPar Keywords`_  Parameters for cube spectral extraction algorithms                               
